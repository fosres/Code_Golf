...
i(T*r){if(!r){return;}i(r->l);if(!r->l&&!r->r){printf("%d ",r->v);}i(r->r);}l(T*r){if(!r){return;}if(r->l){printf("%d ",r->v);}l(r->l);}ri(T*r){if(!r){return;}ri(r->r);if(r->r){printf("%d ",r->v);}}e(T*r){l(r);i(r);ri(r->r);}
